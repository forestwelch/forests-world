...
const ArrowLink = ({ href, text }: { href: string; text: string }) => {
  return (
    <Link
      className="group/icon font-semibold text-gray-800 dark:text-gray-200 transition-colors duration-150 ease-in-out hover:text-violet-700 dark:hover:text-teal-400 lg:group-hover/link:text-violet-700 dark:lg:group-hover/link:text-teal-400"
      href={href}
      target="_blank"
